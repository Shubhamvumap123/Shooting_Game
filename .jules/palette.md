...
**Learning:** Replacing text-based keyboard instructions with visual `<kbd>` elements significantly improves scanability for gamers.
**Action:** Use a reusable `Key` component with standard `<kbd>` styling for all input instructions.
