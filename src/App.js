...
// Reusable Key Component for Instructions
const Key = ({ children }) => (
  <kbd className="bg-gray-700 border-b-2 border-gray-600 rounded px-2 py-1 text-xs md:text-sm text-amber-400 font-mono mx-1">
    {children}
  </kbd>
);
