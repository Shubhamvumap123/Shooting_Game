...
// Key component for keyboard shortcuts
const Key = ({ children }) => (
  <kbd className="inline-block px-1.5 py-0.5 mx-1 text-xs font-bold text-gray-100 bg-gray-700 border border-gray-500 border-b-2 rounded shadow-sm">
    {children}
  </kbd>
);
