...
// Key component for better UX
const Key = ({ children }) => (
  <kbd className="bg-gray-700 border-b-2 border-gray-600 rounded px-1.5 py-0.5 text-xs md:text-sm font-bold text-amber-400 font-mono shadow-sm mx-0.5 inline-block min-w-[1.2em] text-center">
    {children}
  </kbd>
);
