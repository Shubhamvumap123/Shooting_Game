...
const Key = ({ children }) => (
  <kbd className="px-1.5 py-0.5 bg-gray-700 rounded text-amber-400 font-mono text-xs font-bold border-b-2 border-gray-600">
    {children}
  </kbd>
);
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-gray-300">
                <li><span className="font-semibold text-white">Navigation:</span>
                  <ul className="pl-4 mt-1 space-y-1 list-none">
                    <li><span><Key>W</Key> / <Key>↑</Key></span> : Move Up</li>
                    <li><span><Key>S</Key> / <Key>↓</Key></span> : Move Down</li>
                    <li><span><Key>A</Key> / <Key>←</Key></span> : Move Left</li>
                    <li><span><Key>D</Key> / <Key>→</Key></span> : Move Right</li>
                    <li><span><Key>Q</Key> / <Key>E</Key></span> : Rotate Ship</li>
                  </ul>
                </li>
                <li className="mt-2">Press <span><Key>Enter</Key> / <Key>Space</Key></span> to Fire.</li>
