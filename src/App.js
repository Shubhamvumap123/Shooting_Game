...
function App() {
  ...
  function drawStars() {
    ...
    ctx.fillStyle = "white"; // Optimization: Set fillStyle once

    const now = Date.now(); // Optimization: Cache time

    stars.current.forEach(star => {
      ctx.beginPath();
      // Optimization: Use globalAlpha instead of string interpolation
