...
const Key = ({ children }) => (
  <kbd className="bg-gray-700 border-b-2 border-gray-600 rounded px-1.5 py-0.5 text-xs md:text-sm font-bold text-amber-400 font-mono shadow-sm">
    {children}
  </kbd>
);
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-gray-300">
                <li><span className="font-semibold text-white">Navigation:</span>
                  <ul className="pl-4 mt-1 space-y-1 list-none">
                    <li className="flex items-center gap-2"><div className="w-24 text-right"><Key>W</Key> / <Key>↑</Key></div> : Move Up</li>
                    <li className="flex items-center gap-2"><div className="w-24 text-right"><Key>S</Key> / <Key>↓</Key></div> : Move Down</li>
                    <li className="flex items-center gap-2"><div className="w-24 text-right"><Key>A</Key> / <Key>←</Key></div> : Move Left</li>
                    <li className="flex items-center gap-2"><div className="w-24 text-right"><Key>D</Key> / <Key>→</Key></div> : Move Right</li>
                    <li className="flex items-center gap-2"><div className="w-24 text-right"><Key>Q</Key> / <Key>E</Key></div> : Rotate Ship</li>
                  </ul>
                </li>
