...
const Key = ({ children, width }) => (
  <kbd className={`bg-gray-700 border-b-2 border-gray-600 rounded px-2 py-0.5 text-xs font-mono text-amber-400 mx-1 inline-block ${width ? width : 'min-w-[1.5rem]'} text-center shadow-sm`}>
    {children}
  </kbd>
);
    ...
    <div className=' bg-gray-900 '>
      <div className='flex items-center justify-center h-screen'>
          ...
          >
            <div className="bg-gray-800 bg-opacity-80 border border-gray-600 rounded-2xl shadow-2xl p-6 w-80 md:w-96 text-white relative">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-gray-300">
                ...
                <li className="mt-2">Press <Key width="min-w-[3rem]">Enter</Key> / <Key width="min-w-[3rem]">Space</Key> to Fire.</li>
        ...
        {showWin && (
          ...
          >
            <div className="bg-gray-800 bg-opacity-90 border-2 border-green-500/50 rounded-2xl shadow-[0_0_50px_rgba(34,197,94,0.3)] p-8 flex flex-col items-center">
