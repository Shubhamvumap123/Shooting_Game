...
const Key = ({ children }) => (
  <kbd className="inline-flex items-center justify-center min-w-[20px] px-1.5 py-0.5 mx-0.5 text-xs font-sans text-gray-200 bg-gray-700 border-b-2 border-gray-600 rounded-md shadow-sm">
    {children}
  </kbd>
);
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base text-gray-300">
                <li><span className="font-semibold text-white">Navigation:</span>
                  <ul className="pl-4 mt-1 space-y-1 list-none">
                    <li><span className="text-amber-500"><Key>W</Key> / <Key>↑</Key></span> : Move Up</li>
                    <li><span className="text-amber-500"><Key>S</Key> / <Key>↓</Key></span> : Move Down</li>
                    <li><span className="text-amber-500"><Key>A</Key> / <Key>←</Key></span> : Move Left</li>
                    <li><span className="text-amber-500"><Key>D</Key> / <Key>→</Key></span> : Move Right</li>
