...
const Key = ({ children }) => (
  <kbd className="inline-flex items-center justify-center min-w-[20px] px-1.5 h-6 text-xs font-bold text-gray-800 bg-gray-200 border-b-2 border-gray-400 rounded mx-0.5 shadow-sm font-sans">
    {children}
  </kbd>
);
